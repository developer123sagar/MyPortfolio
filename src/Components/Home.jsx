        ...
        <>
            <div className="bg-bblack flex py-28 h-full">
                <div className="w-2/4 flex justify-center items-center flex-col ml-32 mb-4">
                    ...
                    <p className='text-base mt-4 text-tgray text-center'>Get your creative, beautiful and engaging website from a passionate, frontend focused Web Developer for clean and efficient code with great user experience.</p>
                ...
                <div className="w-2/4 flex justify-center items-center flex-col">
                        <div className="h-96 w-80 rounded-3xl overflow-hidden text-lg p-0 border-0 object-fill block">
                            <img src={Profile} alt="Profile" className='h-full w-full object-cover block' />
                        </div>
                    <span className='text-3xl text-twhite font-bold mt-5 cursor-pointer'>Roju Ghimire</span>
                </div>
            </div>
        </>
    )
